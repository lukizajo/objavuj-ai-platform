        ...
        {activeTab === 'rewards' && (
          <div>
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-8">
              ...
              <Button
                variant={selectedRewardType === 'streak' ? 'primary' : 'outline'}
                onClick={() => setSelectedRewardType('streak')}
                size="sm"
              >
                {t('rewards.streak')}
              </Button>
                ...
                return (
                  <Card
                    ...
                    className={`p-6 relative overflow-hidden ${
                      isUnlocked 
                        ? `${getRarityBorderColor(reward.rarity)} border-2 shadow-lg` 
                  ...
                  >
                    {!isUnlocked && (
                      <div className="absolute inset-0 bg-background/50 dark:bg-dark-background/50 flex items-center justify-center">
                        <div className="text-center">
                          <Clock className="w-8 h-8 text-text-secondary dark:text-dark-text-secondary mx-auto mb-2" />
                          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
                    ...
                    <div className="text-center">
                      <div className={`text-4xl mb-4 ${isUnlocked ? '' : 'filter grayscale'}`}>
                        {reward.icon}
                      </div>
                      ...
                      {isUnlocked && (
                        <div className="text-sm text-green-600 dark:text-green-400">
                          ✓ {t('rewards.completedOn')} {formatDate(
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-sm text-text-secondary dark:text-dark-text-secondary">
                          ...
                          <span>•</span>
                          <span>{entry.streakDays} dní séria</span>
                        </div>
                      </div>
        ...
        {activeTab === 'progress' && (
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Current Level */}
              <Card className="p-6">
                <h3 className="text-xl font-bold text-text-primary dark:text-dark-text-primary mb-4 flex items-center gap-2">
                  <Star className="w-5 h-5" />
                  {t('rewards.levels')}
                </h3>
                <div className="text-center">
                  <div className="text-6xl mb-4">🚀</div>
                  <h4 className="text-2xl font-bold text-text-primary dark:text-dark-text-primary mb-2">
                    {userStats.level}
                  </h4>
                  <p className="text-text-secondary dark:text-dark-text-secondary mb-6">
                    {userStats.totalPoints} / 1500 bodov
                  </p>
                  <div className="w-full bg-muted dark:bg-dark-muted rounded-full h-3 mb-2">
                    <div 
              ...
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  {userUnlockedRewards.slice(-3).map((reward) => (
                    <div key={reward.id} className="flex items-center gap-3 p-3 bg-muted dark:bg-dark-muted rounded-lg">
                  ...
                  {userUnlockedRewards.length === 0 && (
                    <div className="text-center py-8 text-text-secondary dark:text-dark-text-secondary">
                      ...
                      <p>Zatiaľ nemáte žiadne úspechy</p>
                      <p className="text-sm">Začnite sa učiť a získajte svoju prvú odmenu!</p>
                    </div>
                  )}
                </div>
              </Card>
