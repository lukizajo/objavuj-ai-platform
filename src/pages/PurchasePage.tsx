        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 h-fit">
              ...
              <div className="mt-6 p-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-800 rounded-xl">
                <div className="text-center">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 text-sm font-medium rounded-full mb-3">
                    <span>🎁</span>
                    Zvýhodnená ponuka
                  </div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                    Kúp kurz + Use Cases za zvýhodnenú cenu
                  </h4>
                  <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">
                    Získajte kompletný kurz AI spolu s praktickými Use Cases za špeciálnu cenu
                  </p>
                  ...
                  <button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all duration-200 text-sm">
                    Pridať bundle do košíka
                  </button>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    UI only - bez platobnej logiky
                  </p>
                </div>
              </div>
